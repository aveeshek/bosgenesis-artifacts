...
- Scope is limited to read-only MoP document generation.
...
## 5. Source Evidence
- k8s-inspector status: `blocked`
- helm-manager status: `blocked`
- mop-creation-agent status: `blocked`
...
- Limitations:
- k8s-inspector evidence limited: Environment 'kubernetes_generic' is outside the policy ODD.; Namespace 'signoz' is outside the policy ODD.
- helm-manager evidence limited: Environment 'kubernetes_generic' is outside the policy ODD.; Namespace 'signoz' is outside the policy ODD.
- mop-creation-agent evidence limited: Environment 'kubernetes_generic' is outside the policy ODD.; Namespace 'signoz' is outside the policy ODD.
